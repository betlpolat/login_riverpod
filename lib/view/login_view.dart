...
//     await _manager.init();
//     await ref.read(authProvider.notifier).isValidToken(_manager);

//     if (ref.watch(authProvider).isRedirect ?? false) {
//       // print(_manager.getString(SharedKeys.token));
//       setState(() {
//         isDirect = true;
//       });
//     }
//     // if (_manager.getString(SharedKeys.token) != "") {
//     //   print(_manager.getString(SharedKeys.token));
//     //   setState(() {
//     //     isDirect = true;
//     //   });
